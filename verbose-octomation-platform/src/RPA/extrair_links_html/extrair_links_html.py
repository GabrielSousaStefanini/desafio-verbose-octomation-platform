...
from modules.module_extrair_links import extrair_links_html
...
resultado = extrair_links_html(NOME_AUTOMACAO, ARQUIVO_LOG_CONFIG, ARQUIVO_LOG_PROJETO,registar_log,arquivo_config_rename_rules_json['arquivoEntrada'], arquivo_config_rename_rules_json['arquivoSaida'])
